...
namespace _13._02._23
{
    ...
    class Passport
    {
        ...
        public Passport(string fullname, string birthday, string national, string iD)
        {
            Fullname = fullname;
            Birthday = birthday;
            National = national;
    ...
    class ForeignPassport : Passport
    {
        ...
        public ForeignPassport(string inDate, string outDate, string type,
            string fullname, string birthday, string national, string iD) : base(fullname, birthday, national, iD)
        {
            InDate = inDate;
            OutDate = outDate;
            Type = type;
    ...
    class Sailor : Human
    {
        ...
        public Sailor(string shipName, string name, int age) : base(name, age)
        {
            ShipName = shipName;
        }
        ...
        {
            base.Show();
            Console.WriteLine($"Имя корабля: {ShipName}");
        }
    }
    ...
    class Pilot : Human 
    {
        ...
        {
            base.Show();
            Console.WriteLine($"Дистанция полётов: {Distance} км");
        }
    }
    #endregion
    ...
    internal class Program
    {
        ...
        {
            Builder builder = new Builder("Vse Chyetko", "Israfil", 34);
            builder.Show();
            Figure[] a = new Figure[2];
            a[0] = new Rectangle(3, 5);
            a[1] = new RightTriangle(6, 8);
            Console.WriteLine(a[0].Square());
            Console.WriteLine(a[1].Square());
        }
    }
}
